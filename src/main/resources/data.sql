...
-- Plan A
INSERT INTO plan (code, subtitle, description, monthly_price) VALUES ('PLAN_A', '기본 요금제', '플레이리스트 큐레이션 전용 플랜', 15000);
...
-- Plan B
INSERT INTO plan (code, subtitle, description, monthly_price) VALUES ('PLAN_B', '프리미엄 요금제', '플레이리스트 큐레이션 + 추천곡 전용 플랜', 39000);
